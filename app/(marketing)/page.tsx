...
async function getGitHubStars(): Promise<string | null> {
  try {
    const response = await fetch(
      "https://api.github.com/repos/goldzulu/nextstart",
      {
        headers: {
  ...
  return (
    <>
      ...
      <section className="container grid justify-center gap-6 py-8 md:py-12 lg:py-24">
        ...
        <div className="mx-auto flex flex-col gap-4 md:max-w-[52rem]">
          <p className="max-w-[85%] leading-normal text-slate-700 sm:text-lg sm:leading-7">
            NextStart also includes a blog and a full-featured documentation site
      ...
      <section className="container grid justify-center gap-6 py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex flex-col gap-4 md:max-w-[52rem]">
          ...
          <p className="max-w-[85%] leading-normal text-slate-700 sm:text-lg sm:leading-7">
          NextStart is open source and powered by open source software. The
